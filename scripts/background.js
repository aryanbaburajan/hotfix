/* run settings initialization script on installation */
...
/* save-image: modification of the code from https://github.com/image4tools/Save-Image-as-Type/ as per GNU GPL v2 */
let messages;
...
chrome.contextMenus.onClicked.addListener(async (info, tab) => {
  ...
  if (menuItemId.startsWith("save_as_")) {
    if (mediaType == "image" && srcUrl) {
      ...
      loadMessages();
      let noChange = srcUrl.startsWith(
